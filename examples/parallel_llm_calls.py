...
tree = (
    ...
    ._().Sequence()
    ._()._().LLM("qwen/qwen3.6-plus", make_messages_2, base_url=LLM_BASE_URL, api_key=LLM_API_KEY, reasoning={"enabled": False})
    ._()._().WriteBlackboard(write_response_2)
    ._().Sequence()
    ._()._().LLM("qwen/qwen3.6-plus", make_messages_3, base_url=LLM_BASE_URL, api_key=LLM_API_KEY, reasoning={"enabled": False})
